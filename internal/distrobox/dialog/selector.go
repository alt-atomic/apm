...
func newSelectorModel(containers []service.ContainerInfo, colors app.Colors) selectorModel {
...
func SelectContainer(containers []service.ContainerInfo, colors app.Colors) (string, error) {
	if len(containers) == 0 {
