...
func TestRenderText_TreeFormat(t *testing.T) {
	...
	result := r.RenderText(data, FormatTypeTree, false)
	if result == "" {
...
func TestRenderText_PlainFormat(t *testing.T) {
	...
	result := r.RenderText(data, FormatTypePlain, false)
	if result == "" {
...
func TestRenderText_ErrorFlag(t *testing.T) {
	...
	resultOk := r.RenderText(data, FormatTypeTree, false)
	resultErr := r.RenderText(data, FormatTypeTree, true)
...
func TestRenderText_DefaultsToTree(t *testing.T) {
	...
	treeResult := r.RenderText(data, FormatTypeTree, false)
...
func TestRenderText_NestedData(t *testing.T) {
	...
	for _, ft := range []FormatType{FormatTypeTree, FormatTypePlain} {
