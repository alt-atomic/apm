...
type ReposBody struct {
	...
	Name string `yaml:"name,omitempty" json:"name,omitempty" deprecated:"true"`
...
func (b *ReposBody) Execute(ctx context.Context, bc pkgbuild.RuntimeContext) (any, error) {
	return withDomain(ctx, bc, b.run)
}

func (b *ReposBody) run(ctx context.Context, svc DomainContext) (any, error) {
...
func init() { pkgbuild.Register(TypeRepos, func() pkgbuild.Body { return &ReposBody{} }) }
