...
func (b *GitBody) Execute(ctx context.Context, bc pkgbuild.RuntimeContext) (any, error) {
	return withDomain(ctx, bc, b.run)
}

func (b *GitBody) run(ctx context.Context, svc DomainContext) (any, error) {
...
func init() { pkgbuild.Register(TypeGit, func() pkgbuild.Body { return &GitBody{} }) }
